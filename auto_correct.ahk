...
;------------------------------------------------------------------------------
; Shift+Win+H to auto enter misspelling correction.  It will be added to this script.
;------------------------------------------------------------------------------
...
; The same is done for any other characters that might otherwise
; be a problem in raw mode:
StringReplace, Before, Clipboard, ``, ````, All  ; Do this replacement first to avoid interfering with the others below.
StringReplace, Before, Before, `r`n, ``r, All  ; Using `r works better than `n in MS Word, etc.
StringReplace, Before, Before, `n, ``r, All
StringReplace, Before, Before, %A_Tab%, ``t, All
StringReplace, Before, Before, `;, ```;, All
; Empty clipboard once again
Clipboard =  ; Must start off blank for detection to work.
; Apply auto correction by right click
Send {AppsKey}
Send {Enter}
Send ^+{Left}
Send ^c
...
; The same is done for any other characters that might otherwise
; be a problem in raw mode:
StringReplace, After, Clipboard, ``, ````, All  ; Do this replacement first to avoid interfering with the others below.
StringReplace, After, After, `r`n, ``r, All  ; Using `r works better than `n in MS Word, etc.
StringReplace, After, After, `n, ``r, All
StringReplace, After, After, %A_Tab%, ``t, All
StringReplace, After, After, `;, ```;, All
Clipboard = %ClipboardOld%  ; Restore previous contents of clipboard.
; This will move the InputBox's caret to a more friendly position:
SetTimer, MoveCaret, 10
; Show the InputBox, providing the default hotstring:
InputBox, Hotstring, New Hotstring, Provide the corrected word on the right side. You can also edit the left side if you wish.`n`nExample entry:`n::teh::the,,,,,,,, ::%Before%::%After%
...
:c1*:iphone``::iPhone
:c1*:ipad``::iPad
:c1*:docs``::documentations
:c1*:doc``::documentation
:c1*:mellanox``::Mellanox
:c1*:amazon``::Amazon
:c1*:aws``::AWS
...
:c1*:MLPerf``::MLPerf
:c1*:nlp``::NLP
:c1*:nlp~::Natural Language Processing
:c1*:jensen``::Jensen
:c1*:sa``::SA
:c1*:sa~::Solutions Architect
:c1*:gpu``::GPU
:c1*:gpu~::Graphic Processing Unit
:c1*:dgx``::DGX
:c1*:linux``::Linux
:c1*:vm``::VM
:c1*:vm~::Virtual Machine
:c1*:deepops``::DeepOps
:c1*:ip``::IP
:c1*:CPU``::CPU
:c1*:API``::API
:c1*:SQL``::SQL
::shceulde::schedule
:c1*:RDMA~::Remote Direct Memory Access
:c1*:RDMA``::RDMA
:c1*:RoCE~::RDMA over Converged Ethernet
:c1*:RoCE``::RoCE
:c1*:NeMo``::NeMo
:c1*:ONNX``::ONNX
:c1*:ONNX~::Open Neural Network Exchange
:c1*:ImageNet``::ImageNet
:c1*:AlexNet``::AlexNet
:*:NN~::neural network
:c1*:MIG``::MIG
:c1*:MIG~::Multi-Instance GPU
:c1*:NGC``::NGC
:c1*:NGC~::NVIDIA GPU Cloud
:c1*:CUDA``::CUDA
:c1*:docker``::Docker
:c1*:python``::Python
:c1*:gpus``::GPUs
...
Return
:c1*:vSphere``::vSphere
:c1*:SmartNIC``::SmartNIC
:c1*:AI``::AI
:c1*:AI~::Artificial Intelligence
:c1*:TetaVi``::TetaVi
:c1*:GeForce``::GeForce
:c1*:DPU``::DPU
:c1*:DPU~::Data Processing Unit
:c1*:BCM``::BCM
:c1*:BCM~::Base Command Manager
:c1*:BCP``::BCP
:c1*:BCP~::Base Command Platform
:c1*:OneNote``::OneNote
:c1*:CPUs``::CPUs
:c1*:vGPU``::vGPU
::Amphere::Ampere
:c1*:RTX``::RTX
:c1*:AlphaFold``::AlphaFold
:c1*:AF~::AlphaFold
:c1*:GPUDirect``::GPUDirect
:*:async``::asynchronous
:c1*:USB``::USB
:c1*:ethernet``::Ethernet
:*:hw~::hardware
:*:sw~::software
:c1*:TCP``::TCP
:c1*:UDP``::UDP
:c1*:ConnectX``::ConnectX
:c1*:IPsec``::IPsec
:c1*:OVS``::OVS
:*:RXP~::regular expression processor
:c1*:SDK``::SDK
:c1*:SuperPOD``::SuperPOD
:c1*:Megatron``::Megatron
:c1*:TRT``::TRT
:c1*:TRT~::TensorRT
:c1*:Ubuntu``::Ubuntu
:c1*:JSON``::JSON
:c1*:RShim``::RShim
:c1*:RecSys``::RecSys
:c1*:recsys~::Recommendation Systems
:c1*:Hebrew``::Hebrew
:c1*:Heb``::Hebrew
:c1*:English``::English
:c1*:CuPy``::CuPy
...
:c1*:GDS``::GDS
:c1*:GDS~::GPUDirect Storage
:c1*:IMOD``::IMOD
:c1*:IMOD~::Israel Ministry of Defense
:c1*:NVBug``::NVBug
...
::accessiblie::accessible
:c1*:NDR``::NDR
:c1*:GTC``::GTC
:c1*:HPC``::HPC
::inrastructre::infrastructure
::realted::related
::managmemet::managmenet
::telemtry::telemetry
:c1*:Omniverse``::Omniverse
:*:envs``::environments
:*:tech``::technology
:c1*:iOS``::iOS
:c1*:3D``::3D
...
::acceleraiton::acceleration
:c1*:ResNet``::ResNet
:c1*:MXNet``::MXNet
:c1*:WhatsApp``::WhatsApp
:c1*:IT``::IT
:c1*:OriginAI``::OriginAI
:c1*:PeopleNet``::PeopleNet
:c1*:YOLO``::YOLO
:c1*:TLT``::TLT
...
::happeining::happening
::seemless::seamless
::ineternet::internet
::recognizng::recognizing
::calssify::classify
::throug::through
::cmaeras::cameras
::intteresoted::interested
::certfication::certification
::werend't::weren't
::familir::familiar
:c1*:OVE``::OVE
:c1*:OVE~::Omniverse Enterprise
::simultanosuly::simultaneously
...
::sepeartes::separates
::aribtrary::arbitrary
::incereases::increases
::accssible::accessible
::insuffiecent::insufficient
::proceders::procedures
::soruce::source
::availibility::availability
::apparemtly::apparently
::wheter::whether
::handleing::handling
...
:c1*:Metaverse``::Metaverse
::perfroamcne::performance
::throguh::through
...
::tutorails::tutorials
::cofigure::configure
::perfroamnce::performance
::perforamcne::performance
::intorduced::introduced
::structred::structured
:c1*:DCGM~::NVIDIA Data Center GPU Manager
:c1*:DCGM``::DCGM
::elaborting::elaborating
::infrormation::information
::Preperations::Preparations
::incepction::inception
::Prepation::Prepartion
::accelrating::accelerating
::incpetion::inception
::reasearches::researches
::submiting::submitting
:*:org~::organization
::intoduction::introduction
::satasfied::satisfied
::interset::interest
::elborated::elaborated
::succesffuly::successfully
::deamon::daemon
:c1*:Morpheus``::Morpheus
::recuirting::recruiting
...
::sementics::semantics
:c1*:MDL``::MDL
:c1*:MDL~::Material Definition Language
::prodcut::product
::invlove::involve
::elborating::elaborating
::architecutres::architectures
::archiecture::architecture
::quantiziation::quantization
::exsiting::existing
:*:intro``::introduction
::shcuedling::scheduling
:*:org``::organization
::conntection::connection
::increaes::increase
::mathching::matching
::seinding::sending
::discoeverd::discovered
::detials::details
::transofrmers::transformers
:c1*:DDP``::DDP
:c1*:DDP~::DistributedDataParallel
::enesemble::ensemble
::thershold::threshold
:c1*:TMS``::TMS
:c1*:TMS~::Triton Management Service
::preapred::prepared
::scholership::scholarship
::encrouage::encourage
::investiage::investigate
::porifling::profiling
::Afthermath::Aftermath
::Nisght::Nsight
::behaviour::behavior
::reagrding::regarding
::Snowbaord::Snowboard
::Omniverser::Omniverse
::toturial::tutorial
::custoemr::customer
::wokring::working
...
:c1*:TensorBoard``::TensorBoard
::commnuuication::communication
::acroos::across
::manaully::manually
::moultiple::multiple
::exapmples::examples
...
::invloved::involved
::remotly::remotely
::recgnized::recognized
::originanlly::originally
::Containue::Continue
::owkring::working
::pakcages::packages
::officialy::officially
...
:*:arg``::argument
::Omnvierse::Omniverse
::Omnioverse::Omniverse
::communicty::community
...
::transoformation::transformation
::chrage::charge
...
::interactievly::interactively
::improt::import
::instrcutions::instructions
::Prefenrecnes::Preferences
::reseting::resetting
::vechile::vehicle
::exisitng::existing
...
::brithday::birthday
::Compelted::Completed
::Suprisengly::Surprisingly
::picutre::picture
:c1*:OpenFold``::OpenFold
::insufficicent::insufficient
...
::utilizaing::utilizing
:c1*:PINN``::PINN
:*:PINN~::physical-informed neural network
::comparabale::comparable
::optimizaion::optimization
::direvitavis::derivatives
::forwared::forward
::prvious::previous
::worksapce::workspace
...
::schedulerus::schedulers
::renderrer::renderer
::sutible::suitable
::transoformer::transformer
::somethig::something
::nativly::natively
::Ubunutu::Ubuntu
:*:auto``::automatically
...
:c1*:AHK~::AutoHotKey
:c1*:Bright``::Bright
:c1*:Bright Cluster Manager``::Bright Cluster Manager
:c1*:Bright~::Bright Cluster Manager
:c1*:Azure``::Azure
:c1*:CMSH``::CMSH
:c1*:CMSH~::Cluster Manager Shell
:*:admins``::administrators
::hirerchical::hierarchical
::Etnernet::Ethernet
::tehm::them
::reuqired::required
::licsense::license
...
::attnetion::attention
:c1*:FIL``::FIL
:c1*:FIL~::Forest Inference Library
:c1*:DLI``::DLI
:c1*:DLI~::Deep Learning Institute
::Morphues::Morpheus
:*:init``::initialize
:*:admin``::administrator
:c1*:MAC``::MAC
...
:c1*:FFT``::FFT
:c1*:FFT~::Fast Fourier Transforms
::searilzie::serialize
::piepiline::pipeline
::inferenceing::inferencing
...
:c1*:SID``::SID
:c1*:SID~::Sensitive Information Detection
::morhpues::Morpheus
::lables::labels
::vocabalary::vocabulary
::tranformers::transformers
::thorughput::throughput
:c1*:AE``::AE
:*:ae~::autoencoder
::uncompormised::uncompromised
::Transforimng::Transforming
::frequenceis::frequencies
...
:c1*:VCSA``::VCSA
:c1*:vCenter``::vCenter
:c1*:VCSA~::vCenter Server Appliance
:c1*:SSH``::SSH
::funtionality::functionality
:c1*:vSGA``::vSGA
:c1*:vSGA~::Virtual Shared Graphics Acceleration
::diffeernt::different
::sahre::share
:c1*:QoS``::QoS
...
:c1*:GI~::GPU Instance
:c1*:CI``::CI
:c1*:CI~::Compute Instance
:c1*:Red Hat``::Red Hat
::dekstop::desktop
::licsensing::licensing
::manufactors::manufactures
::montiroing::monitoring
::locading::loading
:c1*:nsight``::Nsight
::resambles::resembles
:c1*:ps``::PS
...
::differetn::different
::probablt::probably
::horovdrun::horovodrun
::cotnainer::container
::Salck::Slack
::attemps::attempts
::inferecning::inferencing
::porbably::probably
:c1*:GCP``::GCP
:c1*:GCP~::Google Cloud Platform
::chek::check
:c1*:EOF``::EOF
:c1*:EOF~::End-of-life
:c1*:DLProf``::DLProf
:c1*:DLProf~::Deep Learning Profiler
::succesffully::successfully
::deosn't::doesn't
::garuenetee::guarantee
::tutrial::tutorial
::sciense::science
...
::soltuions::solutions
:c1*:QAT``::QAT
:c1*:QAT~::Quantization-Aware Training
::quatization::quantization
:c1*:PTQ``::PTQ
:c1*:PTQ~::Post-Training Quantization
::prodcues::produces
::scacles::scales
:*:arch~::architecture
...
::maxmimum::maximum
:c1*:DLA``::DLA
:c1*:DLA~::Deep Learning Accelerator
::specifc::specific
::effiency::efficency
:c1*:ViT``::ViT
:c1*:ViT~::Vision Transformer
...
::exepct::expect
::tyring::trying
::unslected::unselected
::collabotation::collaboration
::optimizng::optimizing
::sysnthetic::synthetic
::controled::controlled
:*:random~::randomization
::Ominverse::Omniverse
::Componontes::Components
::annotatores::annotators
:c1*:PINNs``::PINNs
...
::desgining::designing
:c1*:Revit``::Revit
:c1*:SketchUp``::SketchUp
:c1*:AEC``::AEC
:c1*:AEC~::Architecture, Engineering and Construction
:c1*:Maya``::Maya
::regaring::regarding
::Januar::January
:c1*:Technion``::Technion
:c1*:DIMM``::DIMM
::Budapeset::Budapest
::prespective::perspective
::Januray::January
...
::evryone::everyone
::unathurized::unauthorized
::smaples::samples
::advatnage::advantage
:c1*:GDN``::GDN
:c1*:GDN~::Graphics Delivery Network
:c1*:OEM``::OEM
:c1*:OEM~::Original Equipment Manufacturer
::eaxmple::example
::warhouse::warehouse
:c1*:PaaS``::PaaS
:c1*:PaaS~::Platform-as-a-Service
::achieveing::achieving
::ciritcal::critical
:c1*:GA``::GA
:c1*:GA~::General Availability
::licesning::licensing
::specialsit::specialist
::eberything::everything
::preception::perception
...
::damges::damages
::schdeulrer::scheduler
::realitvely::relatively
::sequal::sequel
::improvmenet::improvement
::clusert::cluster
::perofrmacne::performance
:c1*:PoC``::PoC
::borading::boarding
::asekd::asked
:c1*:DeciAI``::Deci AI
::autonoums::autonomous
::satllite::satellite
::releavnt::relevant
::profilng::profiling
::queires::queries
::hostorical::historical
::inverstigation::investigation
::scehdule::schedule
::moderization::modernization
::eveyrthing::everything
::lebanon::Lebanon
::aircarfts::aircrafts
::prject::project
::benift::benefit
::reschdeuled::rescheduled
:c1*:GUI``::GUI
:*:GUI~::Graphical User Interface
::onbaording::onboarding
::onborading::onboarding
::potentinal::potential
::regading::regarding
::prodcue::produce
::cusomter::customer
::forwrded::forwarded
...
::passthorugh::passthrough
::supprots::supports
::caluclator::calculator
:c1*:GPT``::GPT
::mdoels::models
::cinversion::conversion
:c1*:NCCL``::NCCL
...
:c1*:PyG``::PyG
:c1*:PyG~::PyTorch Geometric
::wrtie::write
:c1*:GNN``::GNN
:c1*:GNN~::Graph Neural Networks
:c1*:DGL``::DGL
:c1*:DGL~::Deep Graph Library
:c1*:ETL``::ETL
:*:ETL~::Extract, Transform and Load
::snet::sent
:c1*:HPE``::HPE
:c1*:Playtika``::Playtika
...
::abstaract::abstract
::presetned::presented
::demonstared::demonstrated
::commercail::commercial
::materils::materials
::crrect::correct
::insufficenet::insufficient
::chnaging::changing
::ticekt::ticket
